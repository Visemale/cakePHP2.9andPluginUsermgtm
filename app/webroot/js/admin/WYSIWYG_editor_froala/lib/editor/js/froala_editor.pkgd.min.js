                ...
                _init: function() {
                    ...
                    for (var n, r, i, a = !(f.ul = !0), o = 0, s = 0; s < e.length; s++) {
                        ...
                        if (d === v(h(v("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(u, d.length - u.length) || C(u)) {
                            if (!((null === (n = l[1]) || new Date(n) < new Date(v("uB2C1D7B5E1E5E4A1E3C11=="))) && 0 < (u || "").length) || C(u)) {
                                f.ul = !1;
                                break
                            }
                ...
                return new function(r, e) {
                    ...
                    u = {
                        ...
                        TK_SEMICOLON: function() {
                            for (N() && (o.space_before_token = !1); f.mode === k.Statement && !f.if_block && !f.do_block;) x();
                            S()
                        },
                        TK_STRING: function() {
                            N() ? o.space_before_token = !0 : "TK_RESERVED" === l || "TK_WORD" === l ? o.space_before_token = !0 : "TK_COMMA" === l || "TK_START_EXPR" === l || "TK_EQUALS" === l || "TK_OPERATOR" === l ? w() || T() : A(), S()
                        },
                        TK_EQUALS: function() {
                            N(), f.declaration_statement && (f.declaration_assignment = !0), o.space_before_token = !0, S(), o.space_before_token = !0
                        },
                        TK_OPERATOR: function() {
                            if (N(), "TK_RESERVED" === l && O(f.last_text)) return o.space_before_token = !0, void S();
                            if ("*" !== s.text || "TK_DOT" !== l) {
                        ...
                        TK_DOT: function() {
                            N(), "TK_RESERVED" === l && O(f.last_text) ? o.space_before_token = !0 : T(")" === f.last_text && h.break_chained_methods), S()
                        },
                        TK_UNKNOWN: function() {
                    ...
                    return r = e, T.opts.wordPasteModal ? function() {
                        if (!a) {
                            ...
                            a = n.$modal, n.$modal.addClass("fr-middle"), T.events.bindClick(r, "button.fr-remove-word", function() {
                                ...
                                e.wordPaste.clean()
                            }), T.events.bindClick(r, "button.fr-keep-word", function() {p
                                var e = a.data("instance") || T;
                                e.wordPaste.clean(!0)
                            }), T.events.$on(be(T.o_win), "resize", function() {
                                T.modals.resize(o)
