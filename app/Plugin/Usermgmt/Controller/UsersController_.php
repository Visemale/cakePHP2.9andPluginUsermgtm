...
class UsersController extends UserMgmtAppController {
	...
	public function addUser() {
                $this->set('title_for_layout', '<i class="fa fa-user-plus"></i> Agregar Usuario');
		...
		if ($this->request -> isPost()) {
			...
			if ($this->User->RegisterValidate()) {
				...
				$this->request->data['User']['password'] = $this->UserAuth->makePassword($this->request->data['User']['password']);
				$this->User->save($this->request->data,false);
				$this->Session->setFlash(__('El usuario fue agregado correctamente'));
	...
	public function editUser($userId=null) {
                $this->set('title_for_layout', '<i class="fa fa-edit"></i> Editar Usuario');
		if (!empty($userId)) {
			$userGroups=$this->UserGroup->getGroups();
			$this->set('userGroups', $userGroups);
